...
const messages = {
  ja: {
    ...
    toolLine: "ライン",
    toolClear: "全削除",
    toolExport: "PNG エクスポート",
    toolExportJson: "JSON エクスポート",
    toolSave: "保存",
    toolLoad: "読み込み",
    toolBringFront: "最前面",
    toolSendBack: "最背面",
    ...
    itemsTitle: "アイコンカタログ",
    itemsBody:
      "サーバーに配置したSVG/PNGをパレットに表示する想定です。",
    ...
    paletteHint:
      "icons ディレクトリに配置した画像が自動的に表示されます。",
  ...
  en: {
    ...
    toolText: "Text",
    toolArrow: "Arrow",
    toolArrowSolid: "Solid",
    toolArrowDashed: "Dashed",
    toolArrowDotted: "Dotted",
    toolLine: "Line",
    toolClear: "Clear",
    toolExport: "Export PNG",
    ...
    itemsBody:
      "SVG/PNG icons placed in the icons directory will appear in the palette.",
    ...
    paletteHint: "Images placed in the icons folder appear automatically.",
