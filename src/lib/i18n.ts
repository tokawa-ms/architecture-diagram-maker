...
const messages = {
  ja: {
    ...
    diagnosticsTitle: "自己診断",
    diagnosticsBody:
      "Cosmos DB と認証方式の接続状況を表示します。",
    diagnosticsCosmosLabel: "Cosmos DB",
    diagnosticsAuthLabel: "認証",
    diagnosticsLoading: "確認中...",
    diagnosticsError: "診断情報の取得に失敗しました。",
    diagnosticsCosmosConnected: "接続済み",
    diagnosticsCosmosError: "接続エラー",
    diagnosticsCosmosNotConfigured: "未設定",
    diagnosticsCosmosReady: "設定済みの Cosmos DB へ接続しています。",
    diagnosticsCosmosConfigMissing:
      "COSMOS_ENDPOINT / COSMOS_DATABASE / COSMOS_CONTAINER を設定してください。",
    diagnosticsCosmosErrorDetail: "接続に失敗しました",
    diagnosticsAuthEntra: "Entra ID (MSAL)",
    diagnosticsAuthSimple: "簡易認証",
    diagnosticsAuthNone: "未設定",
    diagnosticsAuthChecking: "認証情報を確認中...",
    diagnosticsAuthSignedIn: "サインイン済み",
    diagnosticsAuthSignedOut: "未サインイン",
    diagnosticsAuthUnavailable: "認証は使用されていません",
    diagnosticsAuthUserPrefix: "ユーザー:",
    diagnosticsAuthNoUser: "ユーザー情報がありません。",
    diagnosticsAuthSimpleLoggedIn: "簡易認証でログイン中です。",
    diagnosticsAuthSimpleLoggedOut: "簡易認証で未ログインです。",
    diagnosticsAuthNoneDetail:
      "Entra ID も簡易認証も設定されていません。",
    aboutTitle: "アプリ概要",
    aboutBody:
    ...
    storageTargetLabel: "保存先",
    storageTargetCloud: "クラウド",
    storageTargetLocal: "ローカル",
    storageLoad: "読み込み",
  ...
  en: {
    ...
    diagnosticsTitle: "Self diagnostics",
    diagnosticsBody:
      "Shows the connection status for Cosmos DB and the current auth method.",
    diagnosticsCosmosLabel: "Cosmos DB",
    diagnosticsAuthLabel: "Authentication",
    diagnosticsLoading: "Checking...",
    diagnosticsError: "Failed to load diagnostics.",
    diagnosticsCosmosConnected: "Connected",
    diagnosticsCosmosError: "Connection error",
    diagnosticsCosmosNotConfigured: "Not configured",
    diagnosticsCosmosReady: "Connected to the configured Cosmos DB.",
    diagnosticsCosmosConfigMissing:
      "Set COSMOS_ENDPOINT / COSMOS_DATABASE / COSMOS_CONTAINER.",
    diagnosticsCosmosErrorDetail: "Connection failed",
    diagnosticsAuthEntra: "Entra ID (MSAL)",
    diagnosticsAuthSimple: "Simple auth",
    diagnosticsAuthNone: "Not configured",
    diagnosticsAuthChecking: "Verifying authentication...",
    diagnosticsAuthSignedIn: "Signed in",
    diagnosticsAuthSignedOut: "Signed out",
    diagnosticsAuthUnavailable: "Authentication is not enabled",
    diagnosticsAuthUserPrefix: "User:",
    diagnosticsAuthNoUser: "No user info available.",
    diagnosticsAuthSimpleLoggedIn: "Signed in via simple auth.",
    diagnosticsAuthSimpleLoggedOut: "Not signed in via simple auth.",
    diagnosticsAuthNoneDetail:
      "Neither Entra ID nor simple auth is configured.",
    aboutTitle: "About",
    ...
    storageTargetLabel: "Storage",
    storageTargetCloud: "Cloud",
